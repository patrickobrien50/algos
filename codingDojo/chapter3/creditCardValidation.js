...
//the card (13-19 depending on the card), and returns a boolean whether the
//card digits satisfy the Luhn formula, as follows:
//
//  1) Set aside the last digit; do not include it in these calculations (until
//  step 5);
//  2) Starting from the back, multiply the digits in odd positions (last,
//  third-to-last,etc.) by 2;
